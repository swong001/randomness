...
class qrwifi():
    def __init__(self, ssid=None, security=None, password=None, hidden=None, save=None):
        self.ssid = ssid
        self.security = security
        self.password = password
        self.hidden = 'true' if hidden else 'false'
        self.create = True if save else False
        self.data = f'WIFI:S:{self.ssid};T:{self.security};P:{self.password};H:{self.hidden};'
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Generate a printable QR code for sharing your wifi with friends.',
    ...
    parser.add_argument('-d', '--hidden', action='store_true', default=False, help='boolean, is the ssid hidden or visible')
